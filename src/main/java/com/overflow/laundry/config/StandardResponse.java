...
public class StandardResponse<T> {
  ...
  public static <T> ResponseEntity<StandardResponse<T>> success(MessageResponseEnum message, T data) {
    return ResponseEntity
        .status(message.status)
        .body(new StandardResponse<>(true, message.label, data));
  }

  public static <T> ResponseEntity<StandardResponse<T>> error(MessageResponseEnum message, T data) {
    return ResponseEntity
        .status(message.status)
